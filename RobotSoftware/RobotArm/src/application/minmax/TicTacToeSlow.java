...
public class TicTacToeSlow {
    ...
    // Find optimal move // choooseMove(COMPUTER)
    public Best chooseMove(int side) {
        if (GameController.GAME_MODE == GameController.HARD_GAME) {
            ...
            while (true) {
                ...
                if (squareIsEmpty(rand / 3, rand % 3)) {
                    return new Best(0, rand / 3, rand % 3);
                }
            }
